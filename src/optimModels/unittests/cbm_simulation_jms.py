...
#     "glutamate": ["R_ASPGLU2m", "R_GLUt2r", "R_GLUt2n", "R_GLUt5m", "R_GLUt7", "R_GLUt7m", "R_E4HGLUtm", "R_E4HGLUtp"],
#     "glutarate": ["R_4H2OGLTtm", "R_4H2OGLTtp", "R_AKGt2n", "R_AKGt2r"]
#     }
# over_prots = [pyruvate_carboxilase, phophoenolpyruvate_carboxykinase, malate_synthase, malate_dehydrogenase, fumarate_reductase, fumarase, isocitrate_lyase]
    ...
    if not aeroflag:
        if not cobraflag:    # framed sรณ funciona anaerobiosis com a reacao de cima, cobrapy coma as duas
            model.add_reaction_from_str(
                            "r_4598_alt: 0.000190000006114133 s_0529__91__c__93__ + 9.99999974737875e-06 s_0687__91__c__93__ + "
                            "0.000989999971352518 s_1405__91__c__93__ + 1.20000004244503e-06 s_1475__91__c__93__ +"
            ...
            #                  "9.99999974737875e-06 s_0687__91__c__93__ + 0.00264999992214143 s_1198__91__c__93__ +"
            #                  "0.000150000007124618 s_1203__91__c__93__ + 0.000569999974686652 s_1207__91__c__93__ + "
            #                  "0.00270000007003546 s_1212__91__c__93__ + 0.000989999971352518 s_1405__91__c__93__ + "
            #                  "1.20000004244503e-06 s_1475__91__c__93__ + 6.34000025456771e-05 s_1487__91__c__93__ --> s_4205__91__c__93__")
        else:
            model.add_reactions([Reaction(id = "r_4598_alt", name = "r_4598_alt", subsystem = "c", upper_bound = 1000)])
            model.reactions.r_4598_alt.add_metabolites({"s_0529[c]": -0.000190000006114133, "s_0687[c]": -9.99999974737875e-06, "s_1405[c]": -0.000989999971352518,
                                                        "s_1475[c]": -1.20000004244503e-06, "s_1487[c]": -6.34000025456771e-05, "s_4205[c]": 1.0})
            # # gecko appendix
            # model.reactions.r_4598_alt.add_metabolites({"s_0529[c]": -0.000190000006114133, "s_0687[c]": -9.99999974737875e-06, "s_1198[c]": -0.00264999992214143,
            #                                             "s_1207[c]": -0.000569999974686652, "s_1203[c]": -0.000150000007124618, "s_1212[c]": -0.00270000007003546 ,
            #                                             "s_1405[c]": -0.000989999971352518, "s_1475[c]": -1.20000004244503e-06, "s_1487[c]": -6.34000025456771e-05, "s_4205[c]": 1.0})


    simulProblem = StoicSimulationProblem(model, constraints = constraints, objective = {biomass: 1}, method = "pFBA", minimize = False, withCobraPy = cobraflag)
    # simulProblem = StoicSimulationProblem(model, constraints = constraints, objective = {succ: 1}, method = "pFBA", minimize = False, withCobraPy = cobraflag)
...
if __name__ == '__main__':
    ...
    constraints = {
        ...
        **{x[0]: (0, 1000) for x in [pyruvate_carboxylase, phosphoenolpyruvate_carboxykinase, fumarate_reductase, isocitrate_lyase, malate_synthase]},  # force flux in direction
    ...
    #Overexps
    overprots = pyruvate_carboxylase + phosphoenolpyruvate_carboxykinase + malate_dehydrogenase + \
                fumarase + fumarate_reductase +  isocitrate_lyase + malate_synthase
