...
def prot_ko_optim(prot_measure_fractions =None, prot_measure_ggdw= None,
                  constraints = None, isMultiProc=False, size=1):
...
if __name__ == '__main__':
    ...
    # analysis_growth("C:/Users/sara/UMinho/Projects/DeCaF/GECKO_results/analysis_essential_no_scale_10e-4.csv",
    #                 scale= False)
